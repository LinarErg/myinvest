...
Процедура СформироватьНаСервере()
	...
	Запрос.Текст = 
		...
		|	АктивыОстаткиОстатки.Актив.Картинка КАК АктивКартинка,
		|	АктивыОстаткиОстатки.Актив.ИмяФайлаБезРасширения КАК АктивИмяФайлаБезРасширения,
		|	АктивыОстаткиОстатки.Актив.РасширениеФайла КАК АктивРасширениеФайла
		|ИЗ
	...
	Пока ВыборкаПортфель.Следующий() Цикл
		...
		Пока ВыборкаАктивВид.Следующий() Цикл
			...
			Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
				...
				Картинка = ВыборкаДетальныеЗаписи.АктивКартинка.Получить();
				Попытка
					ОблСтрокаАктив.Рисунки.D1.Картинка = Новый Картинка(Картинка);
				Исключение					
				КонецПопытки;
